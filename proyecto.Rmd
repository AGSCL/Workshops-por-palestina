---
title: 'Instalando R y Rstudio y generar un proyecto' #cuidado con tilde
...
```{r Fig tiktok1, fig.align="center", message=FALSE, warning=FALSE, cache=T, echo =F, error=T, eval=T}
tt_url <- "https://www.tiktok.com/@ivelasq3/video/7027084397421546758"
tt <- tiktokrmd::tiktok_embed(tt_url)
tiktokrmd::tiktok_html(tt, include_player = T)
...
<span style="background-color: #FFFF00; font-size: 20px;">
[**ENLACE FORMULARIO**](https://docs.google.com/forms/d/e/1FAIpQLSdPhIwiY_7at09GM-KkAgklmWHamWcWaPY-yeoPVMoWeIRI2w/viewform?usp=sf_link)
</span>
...
- Pueden consular otros canales como el del Instituto Nacional de Estadísticas: 

```{r , echo=F}
vembedr::embed_url("https://youtu.be/RYa_xYWKPVM")
```
