...
- Problemas frecuentes:
  ...
  - Ver el siguiente [ENLACE](https://agscl.github.io/Workshops-por-palestina/proyecto.html.html)
...
- **.R:** Guión. Archivo de texto plano para guardar comandos, anotaciones, etc. Como un archivo `.do`/sintaxis. Guarde sus scripts antes de cerrar la sesión. **.Rdata != .R, RECUÉRDELO**.
:::
...
- R es un lenguaje de programación, por lo que se puede aprender a programar en R.

- **Swirl** es un paquete que permite aprender R desde R, con ejercicios interactivos y prácticos.

::: {.columns}

::: {.column width="50%"}

- Còdigo adaptado de José Rosa

```{r, eval=F, echo=T}
# Instala estos paquetes si no se encuentran instalados: 
# "devtools", "bitops", "RCurl", "stringi", "httr", "swirl"
...
#Ve si existe una carpetcon el curso instalado. Si no, la instala
if (file.exists("/opt/R/home/library/swirl/Courses/Programando_en_R")) {
  uninstall_course("Programando_en_R")
}
# Instala el curso de Programando en R desde GitHub
...
Puede hacerlo en [Google Colab](https://colab.research.google.com/drive/13zlkZP78a-trEanJ7Dh1Xpz3pHAaPJeo?usp=sharing)
